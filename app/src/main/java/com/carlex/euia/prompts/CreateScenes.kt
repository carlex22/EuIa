...
Passo 8. seje criativo e pense no texto para PROMPT_PARA_IMAGEM. siga estas diretrizes CRUCIAIS para garantir excelência e realismo, e evitar problemas comuns:
    ...
    D.  **Inicio prompt**
     ...
     E.  **Tempo duracao das cenas**
         ...
         *  A promeira cena deve comecar em 0.0Seg 
         *  As demais cenas iniciaram no tempo do fim da anterrior
         *  A ultima cena inicia no tempo do fim da anterrior, o tempo do seu fim deve ser aredondado para o proximo segundo inteiro 
