...
object WorkerTags {
    ...
    const val SCENE_PREVIEW_WORK = "scene_preview_work" // <<< NOVA TAG ADICIONADA
    const val IMAGE_DOWNLOAD_WORK = "image_download_work" // <<< NOVA TAG ADICIONADA
const val REF_IMAGE_ANALYSIS = "ref_image_analysis_work"
    const val POST_PRODUCTION = "post_production_work"
